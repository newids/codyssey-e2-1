...
⁠⁠
# 1. 미션 소개
![header image](Mission-e2-1.jpeg)
...
- 형식: Markdown, Word, hwp 등 (a4 인쇄 기준 2p 이내)
- 내용: 문제 정의, 타겟 사용자, 서비스 개요, AI 기술 적용 방안, 기대 효과를 포함한 기획서 작성

### 2. 발표 자료

- 형식: PPT 또는 PDF (10P 이내)
...
- 7대 도메인 리스트: AI Mobility, AI Energy, AI Robotics, AI Smart Factory, AI Healthcare, AI Fintech, AI E-Commerce

### 2. 팀 구성

- 팀 인원: 3~5인 (인원 현황에 따라 유동적 운영)
- 구성 방식: 구글폼 신청자를 대상으로 운영진에서 배정
